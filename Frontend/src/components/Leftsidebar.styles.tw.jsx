        ...
        <Lfsb>
            <div className="text-white h-full w-full flex justify-center items-center">
                <div className="h-full w-5/6 overflow-auto">
                    ...
                    <div className="h-fit w-full space-y-3 mt-2">
                        <div>
                            <button className="w-full bg-blue-500 text-lg hover:bg-blue-400 transition-all rounded-full p-2 font-semibold">Add Post</button>
                        </div>
                        <div>
                    ...
                    {/* <div className="flex items-end"> */}
                        <div className="absolute bottom-5 flex items-center p-1 w-5/6 border-2 rounded-full border-neutral-900 cursor-pointer hover:bg-neutral-900 transition-all">
