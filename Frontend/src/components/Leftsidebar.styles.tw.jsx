  ...
  return (
    <Lfsb>
      <div className="px-10 h-16 py-5">
        <img
          src="https://th.bing.com/th/id/OIP.okS93mCT6YKkCCRxowkrFgHaHa?rs=1&pid=ImgDetMain"
          alt="App Logo"
          className="h-16"
        />
      </div>
      <div className="space-y-5 mt-10 px-10">
        ...
        <div>
          <button className="text-white w-full bg-blue-400 rounded-full p-2 font-semibold">
            Post
          </button>
        </div>
      </div>
      <div className="fixed bottom-0 flex justify-center items-center px-10 py-5 space-x-5 w-1/4">
        <img
